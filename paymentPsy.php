   ...
   <!-- <form name="ChooseCourse" method = "post">
        ...
        <p id="course-price-display">Cart Price : <span id="course-price"></span></p>-->
            <div class="item">
              ...
              <p class="item-name">Psychology</p>
              <p class="item-description">Learn psychology via our outstanding Introduction to Psychology course!</p>
            </div>
            <div class="total">Total<span class="price">₹1200</span></div>
          </div>
