   ...
   <!-- <form name="ChooseCourse" method = "post">
        ...
        <p id="course-price-display">Cart Price : <span id="course-price"></span></p>-->
            <div class="item">
              ...
              <p class="item-name">Web Development</p>
              <p class="item-description">Master Web Development using HTML, CSS, JS and PHP in 3 Months!</p>
            </div>
            <div class="total">Total<span class="price">₹2000</span></div>
          </div>
